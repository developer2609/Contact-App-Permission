package com.example.mypermission.modern
...
abstract class MySwipeHelper(val context: Context, private val recyclerView: RecyclerView, internal var buttonWidth:Int):ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT){
